...
- speaker: 提问
  ...
  note: ''
- speaker: 杉森建
  original: I’m in charge as the 2D art director.  The GM of design.  I supervise the dot art (sprite graphics displayed on the game screen). I’ve been involved with the Pocket Monsters series since its inception, so I also supervised the design of the original human and Pokemon characters.  This time I was slightly less involved, but I did work on the hero and Pokemon designs.
  translation: 我担任2D美术总监，是设计方面的总负责人。我监督点阵图（游戏画面中显示的精灵图形）。我从《宝可梦》系列诞生之初就参与其中，所以也监督了最初的人类和宝可梦角色的设计。这次我参与得稍微少一些，但确实参与了主角和宝可梦的设计。
  note: 点阵图指像素画，是早期游戏的主要图形形式。
- speaker: 大村祐介
  original: I’m in charge of 2D graphics. I started with Pocket Monsters Diamond and Pearl, and this time I worked on the designs of the human characters and Pokemon such as Mijumaru.
  translation: 我负责2D图形。我从《宝可梦 钻石／珍珠》开始参与，这次负责了人类角色和诸如水水獭等宝可梦的设计。
  note: 水水獭是《宝可梦 黑／白》的初学者宝可梦之一。
- speaker: 杉森建
...
- speaker: 提问
  ...
  translation: 这次所有的宝可梦都是全新的。你们是从什么时候开始设计这些宝可梦的？
  note: ''
- speaker: 大村祐介
  original: Around the Spring of 2008.
  translation: 大约在2008年春天。
  note: ''
- speaker: 杉森建
  original: We were developing it at the same time as Pocket Monsters Platinum and Pocket Monsters Heart Gold and Soul Silver.  In this game, since old Pokemon do not appear, and a new world is the stage, we needed to create an ecosystem purely for the newly-designed Pokemon.  Up until now, we designed with the philosophy that, “a mouse-like Pokemon already exists, so let’s make other Pokemon”—but this time they were all new.  So, once again we designed a mouse-like Pokemon, a dog-like Pokemon, etc. from scratch.
  translation: 我们是在开发《宝可梦 白金》和《宝可梦 心金/魂银》的同时进行开发的。在这款游戏中，由于旧宝可梦不会出现，舞台是一个新世界，我们需要为全新设计的宝可梦创造一个纯粹的生态系统。到目前为止，我们一直秉持着“已经有类似老鼠的宝可梦了，所以让我们制作其他宝可梦”的理念来设计——但这次它们全都是新的。所以，我们再次从零开始设计了类似老鼠的宝可梦、类似狗的宝可梦等等。
  note: ''
- speaker: 提问
  original: Then, you started from nothing in the true sense of the word.  What kind of Pokemon did you think of?
  translation: 那么，你们真的是从零开始的。你们当时想到了什么样的宝可梦？
  note: ''
- speaker: 杉森建
  original: At first I told the designers, “You can draw freely; draw things you like.” Gradually, the number of Pokemon was decided, and the instructions became more concrete, such as, “We don’t have enough of this Type, can you try to draw some?”  By the end they were directly ordered, “Draw this Pokemon!”
  translation: 起初我告诉设计师们：“你们可以自由绘制；画你们喜欢的东西。”渐渐地，宝可梦的数量被确定下来，指示也变得更加具体，比如：“这个属性不够，你能试着画一些吗？”到最后，他们直接接到命令：“画这只宝可梦！”
  note: ''
- speaker: 井部真那
  original: I like dogs, so I submitted a dog-like Pokemon.
  translation: 我喜欢狗，所以我提交了一只类似狗的宝可梦。
  note: ''
- speaker: 杉森建
...
- speaker: 提问
  ...
  note: Mijumaru 即水水獭，Tsutaaja 即藤藤蛇。
- speaker: 杉森建
...
- speaker: 杉森建
  original: Since it was discomforting, if we took that away, it would become a character without any personality.
  translation: 既然它让人不适，如果我们去掉这一点，它就会变成一个没有个性的角色。
  note: ''
- speaker: 提问
  original: You combined the elements of the Grass-type and the snake to create a Pokemon.
  translation: 你们将草属性和蛇的元素结合起来创造了一只宝可梦。
  note: ''
- speaker: 杉森建
...
- speaker: 井部真那
  original: I also went to zoos and pet shops where I could actually touch the animals.  I checked where the joints met and watched how the birds folded their wings. (laughs)
  translation: 我也去了动物园和宠物店，在那里我可以实际触摸动物。我检查了关节的连接处，观察了鸟类如何折叠翅膀。（笑）
  note: ''
- speaker: 提问
  original: That’s interesting.  What ended up being your best reference?
  translation: 真有趣。最终对你们来说最好的参考是什么？
  note: ''
- speaker: 大村祐介
