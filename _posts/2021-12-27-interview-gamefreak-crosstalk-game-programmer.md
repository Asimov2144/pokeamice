...
- type: paragraph
  ...
  translation: 在GAME FREAK，如今游戏制作方式本身正在发生巨大变革。例如《Pokémon LEGENDS 阿尔宙斯》。这款游戏采用了与以往截然不同的方法推进开发。为了提供全新的体验，我们不受既有常识束缚，积极引入新技术与新手法。
  role: answer
- type: paragraph
  speaker: K.I.
  ...
  translation: 那感觉就像是抛开以往的开发流程，从零开始构建游戏。在推进项目之前，我们首先制作了“野生宝可梦栖息在旷野中，向其投掷球进行捕捉”这一核心玩法的原型，并对趣味性进行了彻底验证。而站在这一核心位置上的，正是游戏程序员。
  role: answer
- type: paragraph
  speaker: M.O.
  ...
  translation: 从试作阶段开始，我们就深入探讨了“躲在草丛中接近宝可梦时，宝可梦的视线和动作怎样才显得像生物般自然、让人觉得有趣？”这样的问题。并非只是将企划者脑中想好的规格单纯实现出来，而是程序员自己主动提出“这样动起来会不会更真实、更有趣”，并将其付诸实现。
  role: answer
- type: paragraph
  speaker: K.I.
  ...
  translation: 最近我们在试作阶段投入了更多时间。由此，我们实现了仿佛宝可梦就生活在游戏世界中一般、充满真实感的全新体验。游戏程序员将玩法创意直接落实到代码中，在确认手感的同时不断进化的文化，正变得越来越稳固。
  role: answer
- type: paragraph
  speaker: M.O.
  ...
  translation: 在《宝可梦》系列中，每一部作品都在挑战动作游戏要素、开放世界要素等全新玩法。正是在挑战新事物时，游戏程序员的实力才得以展现。我们需要的是能够享受“如何实现”这一过程、并突破未知课题的人。
  role: answer
- type: image
...
- type: paragraph
  ...
  translation: 作为今后游戏程序员的愿景，我们希望将“游戏的趣味性”体系化。把每个人通过反复试错积累的经验诀窍和手感直觉，作为整个组织的知识共享出来，构建一个无论谁都能创造出高品质玩法的基础。
  role: answer
- type: paragraph
  speaker: M.O.
  ...
  translation: 哪怕只是一个跳跃动作，要让用户操作起来感觉舒适也是非常困难的。我自己也曾为此大费苦心。起跳的动作、滞空时间、着地硬直、重力的施加方式……这些数值要如何调整才能让人感到“舒适”？将这类感觉层面的东西语言化，并作为经验诀窍积累下来，是非常重要的。
  role: answer
- type: paragraph
  speaker: K.I.
  ...
  translation: 例如，验证并调整投出的球以怎样的旋转和轨迹飞行才会让用户感到舒适。在旷野中奔跑转弯时的惯性、镜头的跟随程度等等，深挖细节中蕴含的“快感”，正是游戏程序员的工作。
  role: answer
- type: paragraph
  speaker: M.O.
  ...
  translation: 游戏程序员与系统程序员的不同之处在于，前者专注于思考“玩法”并将其转化为具体形式。“人会觉得什么有趣”“对于怎样的输入给予怎样的反馈才能获得快感”。我们带着接近心理学和人体工学的视角来编写程序。
  role: answer
- type: paragraph
  speaker: K.I.
  ...
  translation: 我们希望增加更多对“追求趣味性”这种感性层面感兴趣的人。目前，系统程序员已经为我们搭建好了各种技术基础和开发效率化工具，游戏程序员能够更加专注于“玩法的趣味性”的环境正在逐步完善。
  role: answer
- type: image
...
- type: paragraph
  ...
  translation: 我们寻求的人才，果然是“能够捕捉玩法本质的人”。例如“做躲猫猫时，婴儿为什么会高兴？”“积木倒塌时，孩子为什么会笑？”能够对日常生活中这些情感波动和游戏根源产生兴趣的人，适合这份工作。
  role: answer
- type: paragraph
  speaker: K.I.
  ...
  translation: 《宝可梦》系列是一款内含多种玩法要素、深受全球众多玩家喜爱的作品。除了RPG要素之外，还拥有动作性、探索、交流等多方面的魅力。正因如此，我们希望与不仅对游戏、还对广泛文化和体验保持敏感的人一起工作。
  role: answer
- type: paragraph
  speaker: M.O.
  original: ゲームが好きなことはもちろん、スポーツが好き、アウトドアが好きなど、何でもいい。それぞれの経験から遊びの本質につながりそうなものを見つけ出し、ゲームに落とし込める引き出しの多さが強みになります。
  translation: 喜欢游戏自不必说，喜欢运动、喜欢户外活动等等，什么都可以。从各自的经历中找出能与游玩本质相关联的东西，并将其融入游戏中的储备越多，就越能成为你的优势。
  role: answer
- type: paragraph
  speaker: K.I.
  original: 「それ面白いね、ゲームになりそうだね」「やってみようか！」といった会話が日常的に行われ、新しい提案が生まれる。それを、スピード感を持ってプロトタイプとして実装できるのが、ゲームフリークのプログラマの最高の面白さだと思います。
  translation: 日常中会有“那个挺有意思的，感觉能做成游戏”“要不要试试看！”这样的对话，新的提案由此诞生。而能够以极快的速度将其作为原型实现出来，我认为这正是GAME FREAK程序员最大的乐趣所在。
  role: answer
entities:
  people:
  - "M.O."
  ...
  works:
  - 宝可梦传说 阿尔宙斯
display_title: 最重要的是否能把握住“玩法的本质”。
original_lang: ja
summary: "GAME FREAK 开发一部模块总监 M.O. 与开发二部部长 K.I. 对谈游戏程序员工作。两人均于2010年入职，M.O. 自《宝可梦 黑／白》起参与正统作品，K.I. 因《宝可梦 红／绿》立志入行。对谈以《Pokémon LEGENDS 阿尔宙斯》为例，说明团队先制作投球捕捉野生宝可梦的原型验证趣味，再推进开发；程序员主动提出宝可梦视线与动作方案。文中还谈及跳跃、球旋转轨迹、奔跑惯性与镜头跟随等手感调整，并提出将趣味性经验体系化、共享给组织。"
dek: "GAME FREAK 程序员谈玩法本质与开发变革"
topics:
- "开发流程"
- "系统设计"
- "玩法验证"
