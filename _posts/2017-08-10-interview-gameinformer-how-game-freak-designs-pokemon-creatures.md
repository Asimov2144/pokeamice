...
original_link: https://www.gameinformer.com/b/features/archive/2017/08/10/heres-how-game-freak-designs-pokemon-creatures.aspx
...
- type: image
  ...
  caption: Game Freak 内部开发企划档案与设计草案
  alt: Game Informer - How Game Freak Designs Pokémon Creatures - Figure 1
- type: paragraph
  ...
  translation: 在过去20年间发售的所有宝可梦游戏中，考虑到超级进化以及《太阳／月亮》中阿罗拉形态等新要素，宝可梦的总数已达802只。这些生物的设计差异之大令人惊叹，既有基于钥匙和垃圾堆等奇特灵感的设计，也有基于猫和考拉等可爱动物的较为常见的设计。在赴日探访Game Freak开发工作室期间，我们与宝可梦总监、制作人兼作曲家增田顺一进行了交谈，聊到了宝可梦的设计流程是怎样的、他们是否曾遇到过被立即否决的内部提案，以及这些年来宝可梦的眼睛发生了怎样的变化。
  speaker: null
- type: paragraph
  original: Pitches for new creatures come from every corner of the studio. “The graphic designers are obviously going to be the ones finalizing the look, but it’s not just the graphic designers who come up with ideas or draw the Pokémon,” Masuda says. Sometimes a battle designer might want to feature a specific move in the game, which requires a specific creature. A story writer might want to execute a narrative beat that requires a new monster. Alternatively, it might be as simple as a graphic designer wanting to explore an animal that it has not yet inspired a Pokémon yet. “These ideas come from a lot of different places, the gameplay, the visuals, the story, and in the end those ideas just get centralized and designed,” Masuda says.
  translation: 新生物的设计提案来自工作室的各个角落。“平面设计师显然会是最终确定外观的人，但提出创意或绘制宝可梦的并不只有平面设计师，”增田说道。有时战斗设计师可能希望在游戏中呈现某个特定招式，而这需要一只特定的生物。剧情编剧可能想要实现一个叙事节点，而这需要一只新的怪物。又或者，可能只是某位平面设计师想要探索一种尚未被用作宝可梦灵感的动物那么简单。“这些创意来自许多不同的地方——玩法、视觉、故事，最终这些创意会被集中起来并进行设计，”增田说道。
  speaker: 增田顺一
  role: answer
- type: image
  image: /assets/img/interviews/2017-08-10-interview-gameinformer-how-game-freak-designs-pokemon-creatures/design_02.jpg
  caption: Game Freak 会议室陈列架上摆放的全世代宝可梦官方模型
  alt: Game Informer - How Game Freak Designs Pokémon Creatures - Figure 2
- type: paragraph
  original: There are few, if any, hard and fast rules about what a Pokémon can and cannot be. “One thing we always really pay attention to is treating them like living creatures so you have to try and imagine where it would live in the environment and why it looks the way it does, what would it eat? For example,” Masuda says. “When designing Pokémon, and not just from a graphic design perspective, there must be a reason for why it looks the way it does and you have to think about why it might live in the Pokémon world.”
  translation: 关于宝可梦能是什么、不能是什么，即便有，也很少有硬性规定。“我们始终真正关注的一点是，把它们当作活生生的生物来对待，所以你必须试着想象它会在环境中住在哪里、为什么它长成这个样子、它会吃什么？诸如此类，”增田说道。“设计宝可梦时，不仅仅是从平面设计的角度出发，它长成这个样子必须有原因，你必须思考它为什么会生活在宝可梦世界中。”
  speaker: 增田顺一
  role: answer
- type: image
  image: /assets/img/interviews/2017-08-10-interview-gameinformer-how-game-freak-designs-pokemon-creatures/design_03.jpg
  caption: 增田顺一在白板上随手画出的‘三头猫’草图，用以阐释‘进化不能只靠简单堆砌器官’的逻辑
  alt: Game Informer - How Game Freak Designs Pokémon Creatures - Figure 3
- type: paragraph
  original: Pokémon designs rarely get cancelled, so to speak. If a new Pokémon weren’t going to fit in the game or world, Game Freak doesn’t let them get far past the conceptual stages. “Once you’re in the middle of creating it and someone were to say, ‘No!, that’s not a Pokémon,’ and the design process gets killed? That doesn’t really happen that much,” Masuda says. “Usually, instead, maybe the person who is directing the game might say it won’t work in its current form, but maybe if you did this and adding ideas onto it might make it work better.” For this reason, ideas for new Pokémon rarely get thrown away.
  translation: 可以说，宝可梦的设计很少会被取消。如果一只新宝可梦不适合游戏或世界观，Game Freak不会让它走得太远，在概念阶段就会止步。“当你正在创作过程中，有人突然说‘不行！那不是宝可梦’，然后设计流程就被叫停？这种情况其实并不太多见，”增田说道。“通常相反的情况是，也许是游戏总监会说它目前的形式行不通，但如果你这样做、再加上一些想法，可能会让它更好地成立。”正因如此，新宝可梦的创意很少会被丢弃。
  speaker: 增田顺一
  role: answer
- type: paragraph
  ...
  translation: Game Freak从事宝可梦开发工作已超过20年，所以到了这个阶段他们知道什么才是一只好的宝可梦，但进化路线仍然可能很棘手。“经常发生的一件事——嗯，也不算经常——但有时会发生的是，你从一只猫开始，当它进化时，一个简单的想法就是说‘好吧，现在它有更多头了’，”增田说着走向身后的白板来阐明他的观点。“我们总是希望确保我们会思考：‘为什么会发生这种事？’当它进化时，为什么它会有三个头？所以这就是我们一直在努力思考的事情——变化的原因是什么，它为什么长成这样？”在匆匆画完用来阐明观点的三头猫之后，增田笑着说：“即使我说我真的很想做这个，大概也会被否决。”
  speaker: 增田顺一
  role: answer
- type: image
  image: /assets/img/interviews/2017-08-10-interview-gameinformer-how-game-freak-designs-pokemon-creatures/design_04.jpg
  caption: 第一世代锐利棱角分明的眼睛与第七世代西狮海壬圆润柔和眼睛的演变对比
  alt: Game Informer - How Game Freak Designs Pokémon Creatures - Figure 4
- type: paragraph
  original: The design process over the years has not remained totally consistent, however, and the community does notice when it shifts. Recently,Reddit user IanMazgeliscreated a post that gained popularity specifically pointing out the way Pokémon’s eyes have changed over the years. Early Pokémon designs feature sharp eyes that were more angular, while later designs round the eyes for a generally softer look. We showed Masuda IanMazgelis’ post in order to find out why the eyes have changed. “It’s definitely conscious of the evolving design, but some of the reason behind that, for example, is in the beginning, the Game Boy had a really limited palette and a very small amount of pixels to express the designs,” Masuda says. “It was hard to make circles so that was one reason a lot of them had a similar look. As the technology evolved we had more options for expression with different shapes and more variety, so I think we’ve focused on trying to have a lot of variety in the eyes, for example.”
  translation: 然而，多年来的设计流程并非始终如一，而玩家社群也确实会注意到其变化。最近，Reddit 用户 IanMazgelis 创建了一个帖子，专门指出宝可梦的眼睛多年来所发生的变化，该帖子获得了不少关注。早期的宝可梦设计以锐利、更具棱角的眼睛为特征，而后来的设计则将眼睛处理得更加圆润，整体观感更为柔和。我们向增田展示了 IanMazgelis 的帖子，以了解眼睛设计变化的原因。“这确实是对设计演变有所意识的结果，但其中部分原因在于，最初 Game Boy 的调色板非常有限，用来表现设计的像素数量也极少，”增田说道。“画圆形很困难，所以这是许多宝可梦看起来相似的其中一个原因。随着技术的发展，我们在表现手法上有了更多选择，可以运用不同的形状和更丰富的多样性，因此我认为我们一直致力于让眼睛等方面呈现出丰富的多样性。”
  speaker: 增田顺一
  role: answer
- type: paragraph
  original: The design and process of creating new Pokémon will likely shift and change as the series moves forward, adapting to who is working in the studio and what ideas the studio wants to convey. It’s reassuring to know, however, that nearly no idea is out of bounds.
