...
- original: 写真右から　アートディレクター：海野隆雄氏、ディレクター：大森 滋氏（以上、ゲームフリーク）、ポケモンキャラクターアートディレクター：氏家淳子氏、ポケモンモーションアドバイザー：畠祐貴氏、キャラクターモデリングアーティスト：中廣健吾氏、ポケモン3Dモデリングリード：植松俊介氏（以上、クリーチャーズ）
  translation: "照片从右起：美术总监 海野隆雄先生、总监 大森滋先生（以上来自GAME FREAK）、宝可梦角色美术总监 氏家淳子女士、宝可梦动作顾问 畠祐贵先生、角色建模艺术家 中广健吾先生、宝可梦3D建模主管 植松俊介先生（以上来自Creatures）"
  type: note
- type: image
...
entities:
  ...
  - 宝可梦 太阳·月亮
original_lang: ja
summary: "CGWORLD 2017年7月号专访GAME FREAK与Creatures，回顾《宝可梦 太阳·月亮》的3D资产管线。文中大森滋、海野隆雄、氏家淳子、畠祐贵、中广健吾、植松俊介等人说明：本作由GAME FREAK自研引擎实现角色与宝可梦同屏，削减约10%处理负荷；宝可梦资产超1000只，其中140余只全新制作，并新增走路与奔跑动作；单只模型约1万至2万多边形、关节最多110根、贴图最大256×512；三社以Alienbrain、Redmine及每两周例会协同，并开发Windows查看器与招式编辑器。"
dek: "三社协同下的3D资产管线与自研引擎"
topics:
- "开发流程"
- "角色设计"
- "系统设计"
