...
title: Game Informer 2019：大森滋与岩尾和昌谈《宝可梦 剑·盾》
display_title: 打造终极宝可梦
dek: Game Informer走访Game Freak东京总部，了解《宝可梦 剑·盾》诸多新增内容与进步背后的灵感。
original_title: Going Big
date: '2019-11-13'
era_skin: '2019'
categories:
- 访谈翻译
...
- 极巨化
- 剑盾封面专题 2019
publication: Game Informer（2019-11-13）
source_kind: media_feature
author: Brian Shea
interviewer: Brian Shea
interviewee: James Turner、增田顺一、大森滋、岩尾和昌
translator: PokeAmice（DeepSeek 初译）
original_lang: en
translation_lang: zh-CN
source:
  title: Going Big
  url: https://www.gameinformer.com/feature/2019/11/13/going-big
  language: en
  source_type: media_interview
original_link: https://www.gameinformer.com/feature/2019/11/13/going-big
summary: Game Informer走访Game Freak东京总部，采访总监大森滋与企划总监岩尾和昌，谈《宝可梦 剑·盾》如何以伽勒尔地区为舞台，在战斗系统、自动保存、训练家自定义等方面挑战系列现状。
entities:
  people:
  - James Turner
  - 增田顺一
...
- original: Now, unrestrained by the traditional limitations of dedicated handheld devices, Game Freak sets out to make what it considers to be the ultimate version of Pokémon. We traveled to the team’s Tokyo headquarters to learn the inspirations behind the various additions and advancements of Pokémon Sword and Shield.
  translation: "如今，不再受限于专用掌机的传统局限，GAME FREAK着手打造它心目中宝可梦的终极版本。我们前往该团队位于东京的总部，了解《宝可梦 剑·盾》诸多新增内容与进步背后的灵感。"
- original: Walking into the unassuming Carrot Tower in Tokyo, you would never guess the creators of the highest-grossing entertainment franchise in the world were just a couple hundred feet above you. After a short elevator ride and a stroll through a plain, twisting hallway, a door opens to a conference room and you’re suddenly presented with the rich history that has been made here. Lining the walls of the conference room is every game, every soundtrack, and hundreds of figures from the world’s largest entertainment juggernaut.
  translation: 走进东京那栋不起眼的胡萝卜塔，你绝不会想到全球最赚钱的娱乐品牌的创造者就在你头顶几百英尺处。乘电梯片刻，穿过一条朴素而蜿蜒的走廊，一扇门打开，通向一间会议室，你突然就被呈现在这里所创造出的丰厚历史面前。会议室墙上排列着这个全球最大娱乐巨头出品的每一款游戏、每一张原声带，以及数百个手办。
  note: 胡萝卜塔（Carrot Tower）是东京世田谷区的一栋高层建筑，Game Freak的办公室曾设于此。
- type: image
  image: /assets/img/interviews/2019-11-13-interview-gi-2019-going-big/001.webp
  alt: Going Big
- original: 'While the shelves housing the mainline entries of the Pokémon series read like a history book for Nintendo’s handheld devices, when you get to the end, Pokémon: Let’s Go, Pikachu and Let’s Go, Eevee immediately stick out as the sole console entries. The games, which released last year on Nintendo’s current flagship platform, effectively transitioned the series to the hybrid format. But while those reimaginings of the first-generation games served as a crowd-pleasing bridge to the next evolution of the franchise, they did more for the development teams at Game Freak.'
  translation: "陈列宝可梦系列主线作品的架子读起来就像一部任天堂掌机史，但当你走到尽头时，《宝可梦 Let's Go！皮卡丘·Let's Go！伊布》立刻显得格外突出，因为它们是仅有的主机作品。这两款游戏去年在任天堂当前旗舰平台上发售，有效地将该系列过渡到了混合形态。不过，尽管这些对第一世代游戏的重制版充当了通往系列下一次进化的、迎合大众的桥梁，它们对GAME FREAK的开发团队来说意义更大。"
- original: The Pokémon Let’s Go games served as a way for the studio to get down the development basics for Nintendo’s new console – introducing new features, like wild Pokémon appearing in the environments and a giant leap forward in terms of visuals. Fans enjoyed these games and loved having a modern remake as a starting point for the franchise on Switch, but Game Freak had greater ambitions with the new technology than simply recreating past glories.
  translation: "《宝可梦 Let's Go》系列游戏让该工作室得以掌握任天堂新主机的开发基础——引入了新特性，比如野生宝可梦出现在环境中，以及在视觉表现上的巨大飞跃。粉丝们喜欢这些游戏，也乐于看到一部现代重制版作为该系列在Switch上的起点，但GAME FREAK借助新技术有着比单纯重现昔日荣光更大的野心。"
- type: image
  image: /assets/img/interviews/2019-11-13-interview-gi-2019-going-big/002.webp
  alt: Going Big
- original: During the development of the Let’s Go games, the team realized creating games on Switch was no small task when compared to developing on lower-resolution handheld devices. “I think the biggest takeaway was how the graphics and rendering work is so different from the 3DS,” says Pokémon Sword and Shield director Shigeru Ohmori. “Needing to staff up and figure out how we’re able to get that to work really well on Switch takes more time, and we needed more resources.”
  translation: 在《Let's Go》系列游戏的开发过程中，团队意识到，与在低分辨率掌机设备上开发相比，在Switch上制作游戏绝非易事。“我认为最大的收获是，图形和渲染的工作方式与3DS如此不同，”《宝可梦 剑·盾》总监大森滋说。“需要扩充人员，并弄清楚如何让它在Switch上良好运行，这需要更多时间，我们也需要更多资源。”
  note: 大森滋是Game Freak的游戏总监，曾执导《宝可梦 太阳·月亮》等作品。
- original: The studio grew in size, nearly doubling the core team since the development of Sun and Moon. With 180 to 200 core members, hundreds of outsourced and external partners, and a large marketing department, the full team is massive. When you factor in the localization teams across the nine languages the game is launching in, Ohmori estimates that around 1,000 names will appear in the credits of Pokémon Sword and Shield.
...
- type: heading
  ...
  original: What’s In A Name?
  translation: 名字里有什么？
- original: Pokémon Sword and Shield’s name draws inspiration from the setting of the Galar region, but a lot more goes into naming than just picking something related to the area. Traditionally, the names of mainline Pokémon games have some relationship to the themes of the game or other games in the series.
  translation: 《宝可梦 剑·盾》的名字灵感来自伽勒尔地区的设定，但命名远不止挑选与地区相关的东西那么简单。传统上，宝可梦主线游戏的名字与游戏主题或系列中其他游戏有所关联。
- original: After two generations of color-based games in Red and Blue followed by Gold and Silver, Masuda thought of Ruby and Sapphire as the start of the “jewel” series, which concluded with the following generation’s Diamond and Pearl. For Black and White, while it was technically a return to color-based naming conventions the series started with, he more wanted to represent two opposing colors. However, starting with X and Y, Masuda was presented with a unique challenge as it was the first time the games were launching worldwide simultaneously.
  translation: 在《红／蓝》和《金／银》两代以颜色为基础的游戏之后，增田将《红宝石／蓝宝石》视为“宝石”系列的开端，该系列以次世代的《钻石／珍珠》告终。对于《黑／白》，虽然从技术上讲是回归系列最初以颜色命名的惯例，但他更想代表两种对立的颜色。然而，从《X／Y》开始，增田面临一个独特的挑战，因为这是游戏首次在全球同步发售。
...
- type: heading
  ...
  original: Turning Trainers Into Stars
  translation: 把训练家变成明星
- original: In addition to getting the visual design to feel authentic, Game Freak wanted to embrace the sports-centric culture of the U.K. Trainers are treated like star athletes, complete with collectible League Cards. While filling your albums with League Cards from A.I. and human trainers can be a fun goal (each card even has trivia or information about the trainer’s personality on the back), I enjoyed creating my own League Card, even with an extremely limited selection available in the build.
  translation: "除了让视觉设计显得真实，GAME FREAK还想拥抱英国以体育为中心的文化。训练家被当作明星运动员对待，还有可收集的联盟卡。用来自AI和人类训练家的联盟卡填满你的卡册可以是个有趣的目标（每张卡背面甚至有关于该训练家的冷知识或性格信息），而我很享受制作自己的联盟卡，即使试玩版里可选的选项极其有限。"
- original: Even before customizing my character’s appearance on the card, I can choose from different backgrounds, effects, and frames. From there, I reposition my trainer on the card, and adjust their pose and facial expression before slapping a laminate coat of my choosing over the entire card.
  translation: 甚至在自定义卡片上角色的外观之前，我就可以从不同的背景、效果和边框中选择。接着，我在卡片上重新摆放我的训练家，调整他们的姿势和面部表情，最后在整张卡片上覆上一层我选定的覆膜。
- original: You can also equip your trainer with a jersey and give them a number. However, if you’d rather go for a more casual look, Pokémon Sword and Shield gives you more customization options than has ever been seen in the series.
  translation: 你还可以给你的训练家穿上球衣并给他们一个号码。不过，如果你更想要休闲一点的造型，《宝可梦 剑·盾》提供的自定义选项比系列以往任何时候都多。
- type: image
  image: /assets/img/interviews/2019-11-13-interview-gi-2019-going-big/009.webp
  alt: Going Big
- original: Past entries let you customize your outfit by selecting a top and a bottom, but now you can take it down to a granular level. Sword and Shield’s trainer customization options allow you to choose shirts, jackets, pants, dresses, socks, shoes, backpacks, hats, glasses, and gloves. You can also choose from several hairstyles to complete the look.
  translation: 过去的作品让你通过选择上衣和下装来自定义服装，但现在你可以细化到更精细的层面。《剑／盾》的训练家自定义选项允许你选择衬衫、夹克、裤子、连衣裙、袜子、鞋子、背包、帽子、眼镜和手套。你还可以从几种发型中选择，来完成整体造型。
- original: The team wanted shopping in the Galar region to remind you of shopping in a fashionable street in England. “That can feel very familiar for people who live in the U.K.,” Turner says. “There were a lot of bits here and there that I pulled from my own experience.”
  translation: 团队希望伽勒尔地区的购物能让你想起在英国时尚街道上购物。“对住在英国的人来说，那会感觉很熟悉，”特纳说。“我从自己的经历里零零碎碎地取了不少东西。”
- original: Much like shopping in real life, you’re going to want to scour all the stores possible to find the right piece to complete your outfit; you can’t just go to one store and expect to see the entire collection of clothes. “There’s actually different clothing brands that serve different genres of clothing, and you’ll find that different towns specialize in some genres over the others,” Ohmori says.
  translation: 和现实生活中的购物很像，你会想尽可能搜遍所有商店，找到合适的那件来配齐你的整套装扮；你不能只去一家店就指望看到全部服装系列。“实际上有不同的服装品牌，对应不同风格的服装，你会发现不同城镇专精于某些风格，而不是其他风格，”大森说。
- type: image
  image: /assets/img/interviews/2019-11-13-interview-gi-2019-going-big/010.webp
  alt: Going Big
- original: Fashion even changes from town to town, encouraging players to bounce around to find the perfect look. “Big-city fashion is different from small-city fashion, and then there are more kind of punkish towns you can visit too,” Turner says.
  translation: 时尚甚至因城镇而异，鼓励玩家四处奔走寻找完美的造型。“大城市的时尚和小城市的时尚不同，然后还有更多有点朋克风格的城镇可以去逛，”特纳说。
- original: The tribute to British sports culture continues with stadiums full of people during big battles. This setting delivers a new kind of atmosphere not seen in mainline Pokémon games to this point. The crowd reacts as action unfolds in the arena, including uproars, cheers, chants, and songs. The stadium itself also changes with the action, with certain things displayed on the screens around the arena, as well as music that plays.
...
- original: Much like Pokémon Go’s raids, the battles are ranked using a star system; the more stars a raid has, the more difficult it will be for players. According to Iwao, players might be in for a rude awakening if they think they can just coast through the higher-ranked Max Raid Battles.
  translation: 和《Pokémon Go》的团体战很像，这些对战用星级系统来分级；团体战的星级越高，对玩家来说难度就越大。据岩尾说，如果玩家以为自己能轻松通过高星级的极巨团体战，可能会被狠狠地上一课。
- original: “I think it’s going to have a kind of difficulty we haven’t seen in a lot of main series Pokémon games up until now,” Iwao says. “Even for me, a seasoned Pokémon player, even if I go with one of the five-star Max Raid Battles, I can definitely run into situations where I’m not able to win.”
...
- original: The myriad advancements of Pokémon Sword and Shield are exciting, but a few months ago, the games made headlines for what’s not going to be in them. During E3 in June, Masuda stated that not every Pokémon from the past will be able to be imported into Sword and Shield. This caused many members of the community to express their disappointment that their favorite Pokémon might be left out from the first all-new generation to appear on consoles.
  translation: 《宝可梦 剑·盾》的种种进步令人兴奋，但几个月前，这两款游戏却因为不会包含的内容而登上头条。在6月的E3上，增田表示并非过去所有宝可梦都能被传入《剑／盾》。这导致社区中许多成员表达失望，因为他们最喜欢的宝可梦可能会缺席这个首个登陆主机平台的全新世代。
- original: When I ask Masuda about the Pokémon not making the journey to the Galar region for Pokémon Sword and Shield, he says having so many Pokémon with each passing generation has become nearly unmanageable if the team wants to continue implementing new features.
...
- original: While it’s disappointing to be potentially unable to import your favorite Pokémon from a past game, there is an additional silver lining outside of the new features this enables Game Freak to implement going forward.
  translation: "虽然可能无法将你过去游戏中的心爱宝可梦传送过来令人失望，但除了这让GAME FREAK今后能够实现的新功能之外，还有另一个好消息。"
