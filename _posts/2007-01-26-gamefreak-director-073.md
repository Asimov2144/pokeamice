...
title: '[GameFreak部长专栏] 第73回'
date: '2007-01-26'
permalink: /gamefreak-director/entry-073/
categories:
- 官方博客
- Game Freak
- 翻译资料
...
gf_entry_no: 73
gf_entry_title: 【开发日记】DS下屏设计的秘密
gf_archive: 2007-01
gf_categories:
- ものづくりについて
- ポケモン
summary: 文章回顾了宝可梦钻石珍珠开发中触控界面的设计思路，以及让玩家自然想去触碰和按下的开关造型。
gf_translation_title: 【开发日记】DS下屏设计的秘密
gf_translation_summary: 文章回顾了宝可梦钻石珍珠开发中触控界面的设计思路，以及让玩家自然想去触碰和按下的开关造型。
search: true
source:
