...
original_link: https://www.gamedeveloper.com/production/how-pokemon-are-born-designing-the-series-iconic-monsters
...
- type: heading
  level: 2
  original: 'The Starters: Faces of the Generation'
  translation: 初始宝可梦：世代的代表
- original: Pikachu may endure, but each game has its own stars -- the trio of 'starters,' the three monsters from which the player selects his or her first companion. Above, you can see the starters from Pokemon X and Y.
  translation: 皮卡丘或许经久不衰，但每款游戏都有自己的明星——即“初始宝可梦”三只，玩家从中选择自己的第一只伙伴。上面，你可以看到《宝可梦 X/Y》中的初始宝可梦。
  note: ''
- speaker: 增田顺一
...
- type: heading
  ...
  translation: 20人委员会与驳回流程
- original: 'As you might imagine, the process of coming up with these monsters is very painstaking:'
...
- type: heading
  ...
  translation: 从设定稿到宝可梦图鉴：最终监修
- original: It's Yoshida's job to supervise the final look of each monster, in the form of setup sheets that contain every detail of their appearance.
  translation: 吉田的职责是以设定稿的形式监修每只宝可梦的最终外观，这些设定稿包含了它们外观的每一个细节。
  note: ''
- speaker: 吉田宏信
