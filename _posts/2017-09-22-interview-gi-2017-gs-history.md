...
title: Game Informer 2017：增田顺一谈《宝可梦 金·银》的开发困境与京都灵感
display_title: 《宝可梦 金·银》开发史
dek: Game Informer走访Game Freak，增田顺一讲述《金/银》在资金与开发困境中成形的过程。
original_title: The History Of Pokémon Gold And Silver
date: '2017-09-22'
era_skin: '2019'
categories:
- 访谈翻译
...
- 森本茂树
- Game Freak 探访 2017
publication: Game Informer（2017-09-22）
source_kind: media_feature
interviewer: Game Informer
interviewee: 增田顺一、大森滋、杉森建、森本茂树
translator: PokeAmice（DeepSeek 初译）
original_lang: en
translation_lang: zh-CN
source:
  title: The History Of Pokémon Gold And Silver
  url: https://gameinformer.com/b/features/archive/2017/09/22/the-history-of-pokemon-gold-and-silver.aspx
  language: en
  source_type: media_interview
original_link: https://gameinformer.com/b/features/archive/2017/09/22/the-history-of-pokemon-gold-and-silver.aspx
summary: Game Informer 2017年探访Game Freak的专题节选。增田顺一讲述《宝可梦 金·银》开发期间的财务压力、以京都奈良为原型的设定过程、岩田聪的协助，以及双地区设计与发售时的成功。
entities:
  people:
  - 增田顺一
  - 大森滋
...
- original: 'Gold and Silver famously includes two regions: Johto, the new region, and Kanto from Pokémon Red and Green. “With Red and Green, this material was still back when it was running on a two-megabit cartridge,” Masuda says, “And halfway through development we upgraded to a four-megabit cartridge, and as programmers were like, ‘Oh my god! Double the space!’” That freedom in size allowed the game’s scope to double.'
  translation: 《金/银》以包含两个地区而闻名：新地区城都，以及《宝可梦 红·绿》的关都。“做红绿的时候，这些素材还是在两兆位卡带上运行的时候，”增田说，“开发到一半我们升级到了四兆位卡带，作为程序员我们就像，‘天哪！空间翻倍了！’”这种容量上的自由让游戏的规模翻倍。
- original: At the time of release, Gold and Silver held the rare achievement of being the fastest-selling games ever.
  translation: 发售时，《金/银》取得了罕见的成就：成为有史以来销售最快的游戏。
- original: For more on the history of Pokémon, you can check out the September '17 issue for a 12-page feature covering the franchise’s history, as well as online features and interviews linked below.
  translation: 欲了解更多宝可梦的历史，可查阅2017年9月刊，其中有一篇12页的专题报道，涵盖该系列的历史，以及下方链接的在线专题和访谈。
