...
interviewee: 任天堂官方注记, 增田顺一, 岩田聪, 石原恒和, 石原恒和 & 增田顺一
toc: true
toc_sticky: true
...
original_link: https://www.nintendo.co.jp/3ds/interview/ekjj/vol1/index4.html
...
- type: dialogue
  speaker: 增田顺一
  original: 「パルレ」というのはフランス語で「おしゃべりをする」という意味です。
  translation: “友友乐”在法语中是“交谈、聊天”的意思。
  note: 法语“parler”意为“说话”，此处与英语“pal”（朋友）结合，形成“宝可友友乐”的命名，体现与宝可梦对话、成为朋友的理念。
- type: dialogue
  speaker: 岩田聪
...
- type: dialogue
  speaker: 石原恒和
  original: あらゆる想いが詰まっている『ポケットモンスター Ｘ・Ｙ』を１０月１２日に発売することを目標にしてきて、それがやっと実現します。また、先ほどもふれたメガシンカは「新しさ」や「過去」を全部表現しているようなところがあるので、みなさんにもぜひメガシンカを体験していただきたいなと思っています。※9メガシンカ＝バトル中にのみ行うことのできる“進化を超えた進化”。メガシンカをすることで、そのポケモンの姿が大きく変わり、能力、特性、タイプなどが変化する。バトルが終了すると、元の姿に戻る。メガシンカについては、「Pokémon Direct 2013.9.4」でくわしく語られている（メガシンカに関する情報は、動画１２分１５秒以降からご覧いただけます）。岩田
  translation: 我们一直以在10月12日发售这部凝聚了所有心意的《宝可梦 Ｘ・Ｙ》为目标，现在终于实现了。另外，刚才提到的超级进化，我觉得它似乎体现了“新意”和“过去”的一切，所以希望大家一定要体验一下超级进化。
  note: '※9: 超级进化＝只能在战斗中进行的“超越进化的进化”。通过超级进化，宝可梦的形态会发生巨大变化，能力、特性、属性等也会改变。战斗结束后会恢复原状。关于超级进化的详细信息，在“Pokémon Direct 2013.9.4”中有详细说明（超级进化的相关信息，可从视频12分15秒之后观看）。'
- type: dialogue
  speaker: 石原恒和 & 增田顺一
