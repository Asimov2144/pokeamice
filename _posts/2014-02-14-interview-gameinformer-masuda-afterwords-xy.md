...
original_link: https://www.gameinformer.com/b/features/archive/2014/02/14/afterwords-unabridged-pokemon-x-and-y.aspx
...
- speaker: 增田顺一
  ...
  translation: 是的，由于该地区以法国为原型，我想在扮演男孩时加入一些与莎娜的浪漫元素，而在扮演女孩时则表达深厚的友谊。例如，在游戏早期穿越森林时，莎娜会走在玩家身后。我们这样做是为了表达莎娜对玩家感兴趣。烟花场景也表达了莎娜与玩家彼此变得更加亲近——从初次见面，到成为朋友，再到成为非常亲密的朋友。
  note: ''
  role: answer
- speaker: 增田顺一
  original: In the future, I think I may add more romantic elements if I can do it in a fun way. However, I don't think I want to take it in a direction that shows people fighting or a relationship falling apart. Doing that would take too much of the focus off of catching Pokémon! (laughs)
  translation: 未来，如果我能以有趣的方式呈现，我想我可能会加入更多浪漫元素。但是，我不希望朝着展现人们争吵或关系破裂的方向发展。那样做会过多地分散捕捉宝可梦的焦点！（笑）
  note: ''
  role: answer
- speaker: 提问
  original: What was the inspiration for Team Flare's evil objective and the character of Lysandre?
  translation: 闪焰队的邪恶目标和弗拉达利这个角色的灵感来源是什么？
  note: ''
  role: question
- speaker: 增田顺一
  original: The idea for Lysandre came up when I was working on AZ's character settings. He's a person who thought AZ's ultimate weapon was brilliant and became obsessed with it. However, he's more obsessed with what he could do with the weapon than what the reason for its creation was originally. I wanted to express how terrifying obsession can be with this character.
  translation: 弗拉达利的想法是在我设计AZ的角色设定时产生的。他认为AZ的最终兵器很出色，并对此着迷。然而，他更着迷于能用这件武器做什么，而不是它最初被创造的原因。我想通过这个角色表达执念有多么可怕。
  note: ''
  role: answer
- speaker: 增田顺一
...
- speaker: 提问
  ...
  role: question
- speaker: 增田顺一
  original: This is simply showing a different way of thinking from a past era. In ancient times, like in the myths and legends we put in the Diamond and Pearl games, it was said that Pokémon were the same as humans. However, I like to think of Pokémon as mysterious creatures – they're closer to humans than dogs or cats that people might keep as pets.
  translation: 这只是在展示过去时代的一种不同思维方式。在古代，就像我们在《钻石/珍珠》游戏中加入的神话和传说那样，据说宝可梦与人类是一样的。然而，我更倾向于认为宝可梦是神秘的生物——它们比人们可能饲养的狗或猫更接近人类。
  note: ''
  role: answer
- speaker: 提问
  original: Occasionally in the game, most notably in Lumiose City, the camera's perspective shifts to rest behind the character's head. Is the team interested in trying to keep this closer perspective throughout an entire game in the future? Or do you see the overhead cameras as a key component of the Pokémon experience?
  translation: 在游戏中，尤其是在密阿雷市，偶尔会切换摄像机视角，从角色背后拍摄。团队是否有兴趣在未来整个游戏中保持这种更近的视角？还是您认为俯视视角是宝可梦体验的关键组成部分？
  note: ''
  role: question
- speaker: 增田顺一
...
- speaker: 提问
  ...
  role: question
- speaker: 增田顺一
  original: We've never decided not to create a Pokémon because it was difficult to make it work as a 3D model. However, some Pokémon that do special things, like the Mega Evolved Gengar, were very difficult to make--not just the 3D modeling, but also the programming involved to make them work in battles.
  translation: 我们从未因为某只宝可梦难以做成3D模型而决定不制作它。然而，一些有特殊表现的宝可梦，比如超级进化的耿鬼，制作起来非常困难——不仅是3D建模，还包括让它们在战斗中正常运作的编程。
  note: 超级进化（Mega Evolution）是第六世代引入的机制，耿鬼的超级进化形态在建模和战斗动画上较为复杂。
  role: answer
- speaker: 提问
  original: The new 3D battles look fantastic, but I'm curious why the Pokémon still have the circular patch of grass or land underneath them? Is there a technical reason for keeping this remnant from the past?
  translation: 新的3D战斗看起来很棒，但我很好奇为什么宝可梦脚下仍然有圆形的草丛或地面？保留这个过去的遗留物有什么技术原因吗？
  note: ''
  role: question
- speaker: 增田顺一
...
- speaker: 提问
  ...
  note: 2DS是任天堂推出的2DS掌机，不支持3D显示功能。
  role: question
- speaker: 增田顺一
...
- speaker: 增田顺一
  ...
  role: answer
- speaker: 提问
  original: What were the discussions like behind the new approach to sharing experience this time around? Some have argued that this item makes the game too easy. Did you have to make an effort to balance the game for both players that used it and those that didn't?
  translation: 这次关于分享经验的新方法，背后的讨论是怎样的？有些人认为这个道具让游戏太简单了。你们是否努力在使用了该道具和未使用该道具的玩家之间平衡游戏？
  note: ''
  role: question
- speaker: 增田顺一
  original: There are so many Pokémon living in the Kalos region, you can encounter a different Pokémon just about every time you go into the tall grass. We wanted players to try raising lots of Pokémon, which is why we changed how the Exp. Share item worked. Of course, we also made it so players could turn off the Exp. Share and still enjoy the game if they wanted to.
  translation: 卡洛斯地区生活着许多宝可梦，你几乎每次进入草丛都能遇到不同的宝可梦。我们希望玩家尝试培养许多宝可梦，这就是我们改变学习装置道具工作方式的原因。当然，我们也让玩家可以关闭学习装置，如果他们愿意的话，仍然可以享受游戏。
  note: ''
  role: answer
- speaker: 增田顺一
...
- speaker: 提问
  ...
  role: question
- speaker: 增田顺一
  original: Because the Pokémon needs to use its held item slot for the Mega Stone that is required to trigger Mega Evolution, I don't think it will represent a huge advantage in competitions. The 2014 Pokémon World Championships will take place in Washington D.C., and qualifying events are underway, so I'm excited to see how the games play out and decide what direction we want to take from there. I hope we get a lot of people to participate in the events.
  translation: 因为宝可梦需要使用其携带道具栏来装备触发超级进化所需的超级石，我认为这不会在比赛中带来巨大优势。2014年宝可梦世界锦标赛将在华盛顿特区举行，预选赛正在进行中，所以我非常期待看到比赛的结果，并决定我们未来要采取的方向。我希望有很多人参加这些活动。
  note: ''
  role: answer
- speaker: 提问
  original: What is the story behind the new Pokémon Klefki? Who's idea was it and why did it make the cut?
  translation: 新宝可梦钥圈儿背后有什么故事？是谁的主意，为什么它能入选？
  note: ''
  role: question
- speaker: 增田顺一
  original: The base idea came from Ms. Ibe – one of our graphic designers. Since the Kalos region has a lot of history, we felt we could attach some story elements to a key design. The idea for Klefki came from thinking of old mansions and secret keys and such.
  translation: 基础想法来自井部女士——我们的一位图形设计师。由于卡洛斯地区历史悠久，我们觉得可以在钥匙设计上附加一些故事元素。钥圈儿的想法源于对古老宅邸和秘密钥匙等的思考。
  note: 井部真那（井部真那）是Game Freak的图形设计师，负责宝可梦设计。
  role: answer
- speaker: 提问
  original: Historically, your trainer's father has been absent, but in Pokémon X&Y your father apparently purchased the computer that's in your room for you. What is your father up to? And where are the fathers of the previous games?
  translation: 从历史上看，训练家的父亲一直缺席，但在《宝可梦 X·Y》中，你的父亲显然为你购买了房间里的电脑。你的父亲在做什么？前几代游戏中的父亲们又在哪里？
  note: ''
  role: question
- speaker: 增田顺一
  original: Wherever could they be? They're probably off working somewhere, or maybe just having Pokémon battles? (laughs) It's apparent that they are at least making enough money to buy the player's character a computer! (laughs)
  translation: 他们会在哪里呢？他们可能在外面某个地方工作，或者只是在打宝可梦对战？（笑）很明显，他们至少赚了足够的钱给玩家角色买电脑！（笑）
  note: ''
  role: answer
- speaker: 提问
  original: In the Lumiose City art museum there's a painting that looks like Red from Pokémon Red & Blue giving flowers to his mother. There are some people nearby that say they are from Kanto staring at the art mentioning how somebody they were traveling with really wanted to see this painting, but they are in the bathroom with stomach problems. The sign by the painting reads, "This masterpiece is a moving tribute to the artist's departed mother." Is this Red from the original Pokémon games? And did his mother pass away?
  translation: 在密阿雷市美术馆里有一幅画，看起来像是《宝可梦 红·蓝》中的赤红在给母亲送花。附近有一些人说他们来自关都地区，盯着这幅画，提到他们同行的某人非常想看这幅画，但那人因胃病在洗手间。画旁的标牌写着：“这幅逸品是对艺术家已故母亲的感人致敬。”这是原版宝可梦游戏中的赤红吗？他的母亲去世了吗？
  note: ''
  role: question
- speaker: 增田顺一
  original: What incredible imagination! I think that's great. The tale about flowers is referring to Shaymin from the Sinnoh region. The guy who is stuck in the bathroom with stomach problems is actually a joke we put in about one of our graphic designers who came down with something while we were on location at the Louvre doing research for the game.
...
- speaker: 提问
  ...
  role: question
- speaker: 增田顺一
  original: Thanks for the tips! (laughs)
  translation: 谢谢你的小费！（笑）
  note: ''
  role: answer
- speaker: 增田顺一
  original: I think we'll be announcing what we wanted to do in regards to tips on the Pokémon Global Link or elsewhere soon.
  translation: 我想我们很快就会公布关于宝可梦全球连接或其他地方的小贴士方面的计划。
  note: ''
  role: answer
- speaker: 提问
  original: How long has Pokémon X&Y been in development? Had work already begun on the game while Black & White 2 were in development?
  translation: 《宝可梦 X·Y》开发了多长时间？在《黑2·白2》开发期间，这款游戏的工作是否已经开始？
  note: ''
  role: question
- speaker: 增田顺一
  original: Yes, the conceptual planning for Pokémon X and Pokémon Y began before Pokémon Black Version and Pokémon White Version were released. The idea for the game first arose around June of 2010. Then we spent 3 years developing the game, and – when you include the localization work – it ended up being a big project on which around 500 people were involved.
  translation: 是的，《宝可梦 X》和《宝可梦 Y》的概念规划始于《宝可梦 黑》和《宝可梦 白》发售之前。游戏的想法最初在2010年6月左右产生。然后我们花了3年时间开发这款游戏，如果包括本地化工作，最终这是一个大约500人参与的大项目。
  note: ''
  role: answer
- speaker: 提问
  original: The pacing of Pokémon X&Y is dramatically sped up compared to previous games. You have your first badge before you meet the Professor Sycamore. Can you talk about why that decision was made? Was there a fear that rookie players would be left behind?
  translation: 与前作相比，《宝可梦 X·Y》的节奏明显加快。在见到布拉塔诺博士之前，你就已经获得了第一枚徽章。能谈谈为什么做出这个决定吗？是否担心新手玩家会跟不上？
  note: ''
  role: question
- speaker: 增田顺一
  original: One thing that I can say is that people these days don't have a lot of time. Kids today are overwhelmed with information and busy on social networks, blogs, etc. When considering the reality of the era, we wanted to make the games easy for new players to get into and also fun for players of previous games. The fact that you get your Pokémon from a group of friends you just met has a modern feel to it.
  translation: 我能说的一点是，如今人们没有太多时间。现在的孩子们被信息淹没，忙于社交网络、博客等。考虑到这个时代的现实，我们想让新玩家容易上手，同时也让老玩家觉得有趣。你从刚认识的朋友那里得到宝可梦这一事实，具有现代感。
  note: ''
  role: answer
- speaker: 增田顺一
...
- speaker: 增田顺一
  ...
  role: answer
- speaker: 提问
  original: Why can't you choose to wear no hat?
  translation: 为什么不能选择不戴帽子？
  note: ''
  role: question
- speaker: 增田顺一
  original: It's a way to symbolize the player's character. You can tell at a glance who it is because of the hat.
  translation: 这是象征玩家角色的一种方式。因为帽子，你可以一眼认出那是谁。
  note: ''
  role: answer
- speaker: 提问
  original: Will there ever be paid DLC for Pokémon X&Y where players will be able to purchase rare Pokémon or additional single-player content?
  translation: 《宝可梦 X·Y》将来会有付费DLC吗？玩家可以购买稀有宝可梦或额外的单人游戏内容？
  note: ''
  role: question
- speaker: 增田顺一
  original: While we won't ever sell Pokémon, we do plan on releasing the Pokémon Bank as a downloadable 3DS application. With it, you'll be able to bring over Pokémon from the previous games and also deposit up to 3,000 of your Pokémon in it.
  translation: 虽然我们绝不会出售宝可梦，但我们确实计划发布宝可梦银行作为3DS的可下载应用程序。通过它，你可以从之前的游戏中带入宝可梦，并且最多可以存放3000只宝可梦。
  note: 宝可梦银行（Pokémon Bank）是任天堂3DS上的一项云存储服务，允许玩家存储和转移宝可梦。
  role: answer
- speaker: 提问
  original: Who do you like to pick as your starters?
  translation: 你喜欢选择哪只初始宝可梦？
  note: ''
  role: question
- speaker: 增田顺一
  original: Fennekin, of course! I love playing with Fennekin in Pokémon-Amie!
