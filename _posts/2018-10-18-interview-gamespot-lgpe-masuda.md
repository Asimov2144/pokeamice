...
title: '[访谈翻译] GameSpot 专访增田顺一：《Let''s Go！皮卡丘／伊布》如何重塑《宝可梦 黄》'
date: '2018-10-18'
toc: true
toc_sticky: true
...
source:
  title: GS LGPE采访
  url: https://www.gamespot.com/articles/how-lets-go-pikachu-eevee-update-pokemon-yellow-fo/1100-6462538/
  language: en
...
entities:
  ...
  - Game Freak
  - Nintendo
original_title: GS LGPE采访
original_link: https://www.gamespot.com/articles/how-lets-go-pikachu-eevee-update-pokemon-yellow-fo/1100-6462538/
...
- type: paragraph
  ...
  note: 增田顺一（Junichi Masuda）是 Game Freak 的董事，长期担任宝可梦系列的游戏总监和作曲家。七坂健作（Kensaku Nabana）是 Game Freak 的环境设计师。
- type: paragraph
  ...
  translation: 尽管灵感来自《宝可梦 黄》，但《Let's Go 皮卡丘》和《伊布》似乎引入了许多以往宝可梦游戏中没有的新元素。我们应该期待哪些新内容？
  role: question
  speaker: 提问
- type: paragraph
  ...
  translation: 故事的主要流程与《宝可梦 黄》非常相似。我们这样做的原因之一是，我们设想很多原版游戏的粉丝会来玩这款游戏。虽然有些部分不同，但我认为他们会认出故事的主要节拍，并感受到一些怀旧之情。
  speaker: 增田顺一
  role: answer
- type: paragraph
  ...
  translation: 同时，我们确实添加了相当数量的原版中没有的支线事件。这给人一种不同的感觉，因为在真实世界中，有很多训练家与他们的宝可梦在一起，所以与原版游戏相比，它会给人不同的印象，同时也涵盖了相同的故事。
  speaker: 增田顺一
  role: answer
- type: paragraph
...
- type: paragraph
  original: 'Masuda: No real details, but I can guarantee it’s very simple. We didn’t really think too much about it and just kept it very simple to trigger Mega Evolutions.'
  translation: 增田顺一：没有真正的细节，但我可以保证它非常简单。我们没有想太多，只是让超级进化的触发方式保持得非常简单。
  speaker: 增田顺一
  role: answer
- type: paragraph
...
- type: paragraph
  ...
  speaker: 锅岛
  note: 此处说话人名字为“Nabana”，根据上下文推测为Game Freak的设计师，但官方译名未定，故音译为“锅岛”。
  role: answer
- type: paragraph
  ...
  translation: 在DS和3DS游戏中，有很多商店活动通过下载代码发放免费宝可梦。对于《Let's Go 皮卡丘/伊布》是否有类似的计划？
  role: question
  speaker: 提问
- type: paragraph
  original: 'Masuda: The functionality from the previous games is in there, it’s called Mystery Gift. It’s in the game and I’m sure there’ll probably be something, but I think with the limited selection of Pokemon, they’re all fairly easily catchable in other games. I’m not sure how often or how frequent it’s going to be with these particular games.'
  translation: 增田顺一：前作中的功能仍然存在，叫做“神秘礼物”。它就在游戏中，我相信可能会有一些活动，但考虑到宝可梦的选择有限，它们在其他游戏中都相当容易捕获。我不确定在这些特定游戏中会有多频繁。
  speaker: 增田顺一
  role: answer
- type: paragraph
  ...
  translation: 我们已经讨论了《宝可梦Go》和《Let's Go》之间的传送。当计划于2019年推出的“核心”宝可梦游戏到来时，是否也会有《Let's Go》与该作品之间的传送可能性？
  role: question
  speaker: 提问
- type: paragraph
...
- type: paragraph
  ...
  speaker: 提问
- type: paragraph
  original: 'Masuda: Definitely Red and Green for me is the most memorable. It was a six year development with just nine of us, so we have a lot of memories from that time, both good and bad. One of the other things was that we didn’t have much expectation that the game would be played by millions of people at the time. We were just developing it. At any time the company could have gone under and it may not have been released. But yeah, a lot of memories from that time.'
  translation: 增田顺一：对我来说，最难忘的绝对是《红/绿》。当时我们只有九个人，开发了六年，所以那段时光里充满了各种回忆，有好的也有坏的。另外，当时我们并没有期望这款游戏会被数百万人游玩。我们只是在开发它。公司随时可能倒闭，游戏也可能无法发售。但确实，那段时光留下了很多回忆。
  speaker: 增田顺一
  note: 《红/绿》指宝可梦系列最初的作品《宝可梦 红/绿》，于1996年在日本发售。增田顺一是Game Freak的创始人之一，也是宝可梦系列的主要作曲家兼游戏设计师。
  role: answer
- type: paragraph
  original: 'Nabana: Red and Green, that’s where I started as well. I played those games and I have great memories playing them, but over the 20 years as time went on, I think the memory got glamorized even more. It starts to just become this legend in my mind. Of course, we tried to make Let’s Go Pikachu and Let’s Go Eevee, the re-imagining of that, to kind of live up to those. It gets more and more beautiful in your mind as time goes on, so that’s what we tried to do. So those are probably my favorite games, just in my memory.'
  translation: 长野大辅：《红/绿》也是我入坑的作品。我玩过那些游戏，并且留下了美好的回忆，但随着20年的流逝，我觉得这些回忆变得更加美化。它在我心中逐渐变成了一个传说。当然，我们试图通过《Let's Go 皮卡丘》和《Let's Go 伊布》来重现那种感觉，不负那些回忆。随着时间的推移，回忆在脑海中变得越来越美好，所以这就是我们努力的方向。因此，在我记忆中，那些可能是我最喜欢的游戏。
  speaker: 长野大辅
  note: 长野大辅是Game Freak的开发者，曾担任《Let's Go 皮卡丘/伊布》的总监。
  role: answer
- type: paragraph
  ...
  translation: 但作为一名开发者，我认为能够参与这些游戏，并尝试为现代玩家更新它们，同时作为团队负责人，这可能是迄今为止我最喜欢的经历。
  speaker: 长野大辅
  role: answer
- type: paragraph
...
- type: paragraph
  ...
  translation: 最后一个问题：我们有机会看到皮卡丘被废弃的进化型“戈罗丘”吗？
  speaker: 提问
  note: 戈罗丘是初代宝可梦设计中皮卡丘的进化型，但最终被取消。
  role: question
- type: paragraph
...
- type: paragraph
  ...
  speaker: 长野大辅
  role: answer
summary: "2018年GameSpot采访《宝可梦 Let's Go！皮卡丘／伊布》总监增田顺一与首席游戏环境设计师七坂健作（译文中亦作菜花健作、长野大辅等），谈以3D重制《宝可梦 黄》的关都地区与最初151只宝可梦。增田说明故事主线沿用《黄》，增加支线，火箭队与武藏、小次郎、喵喵出场更多；为无智能手机的孩子与三十多岁老玩家设计，并联动《Pokémon GO》传送与捕捉机制。游戏有意取消携带物品、特性与蛋，保留超级进化并简化触发，加入精灵球Plus。幻之宝可梦美录坦由Game Freak内部设计、在《Pokémon GO》首发，与Niantic合作。"
