...
title: Polygon 2019：增田顺一与大森滋谈《宝可梦 剑·盾》
display_title: 宝可梦剑盾开发访谈
dek: Game Freak谈Switch主机定位、千人参与规模与部分宝可梦缺席。
original_title: Game Freak explains the 1,000 staff, missing creatures, and leek size of Pokémon Sword and Shield
date: '2019-10-24'
era_skin: '2019'
categories:
- 访谈翻译
...
- 大森滋
- 全国图鉴
publication: Polygon（2019-10-24）
...
source:
  title: Game Freak explains the 1,000 staff, missing creatures, and leek size of Pokémon Sword and Shield
  url: https://www.polygon.com/interviews/2019/10/24/20929597/game-freak-explains-the-1000-staff-missing-creatures-and-leek-size-of-pokemon-sword-and-shield/
  language: en
  source_type: media_interview
original_link: https://www.polygon.com/interviews/2019/10/24/20929597/game-freak-explains-the-1000-staff-missing-creatures-and-leek-size-of-pokemon-sword-and-shield/
summary: Polygon采访制作人增田顺一与总监大森滋，谈《宝可梦 剑·盾》作为首款主机主系列RPG的定位、约千人参与开发的构成、遗留宝可梦缺席的原因，以及大葱鸭进化等设计细节。
entities:
  people:
  - 增田顺一
  - 大森滋
...
- type: heading
  ...
  translation: 主机游戏
- type: image
  image: /assets/img/interviews/2019-10-24-interview-polygon-2019-swsh/001.jpg
  alt: Shigeru Ohmori and Junichi Masuda stand in Nintendo’s Bay Area office
  caption: Shigeru Ohmori (left) and Junichi Masuda (right)
- original: A lot of people talk about this being the first real Pokémon console RPG. Do you think of it that way or is that just what others say?
  role: question
  speaker: Polygon
  translation: 很多人说这是第一款真正的宝可梦主机RPG。你自己也这么看，还是这只是别人的说法？
...
- original: Obviously, historically you guys have resisted targeting consoles. A lot of people speculated for years wondering when it would happen, and it never did until Switch seems like it almost forced it to happen. Was this inevitable? Say hypothetically Switch never happened. Say Switch was a traditional console that didn’t have a portable component. Do you think you would have gone this direction eventually anyway?
  role: answer
  speaker: 大森滋
  translation: 显然，从历史上看，你们一直抗拒以主机为目标平台。很多人多年来一直在猜测这会在什么时候发生，但直到Switch出现，这件事似乎才几乎是被迫发生的。这是不可避免的吗？假设Switch从未出现。假设Switch是一台没有便携部件的传统主机。你觉得你们最终还是会朝这个方向走吗？
- original: It’s kind of hard to speculate where we would have gone if that were the direction, but I do think it’s fair to say that the Pokémon main series RPGs that we develop have a very strong connection with Nintendo hardware. So whatever they put out, they usually take a pretty unique approach with things and we try to kind of match that uniqueness with the games. But, yeah. That’s all I can really say.
  role: answer
  speaker: 大森滋
  translation: 如果真是那个方向，很难推测我们会走向哪里，但我认为可以公平地说，我们开发的主系列宝可梦RPG与任天堂硬件有着非常强的联系。所以无论他们推出什么，通常都会采取相当独特的做法，而我们会试着让游戏与那种独特性相匹配。不过，是的。我能说的就这些。
- original: But of course, if the Switch had come out as a traditional console and then at the same time they had released a separate portable device, I think it would probably be safe to say we would have developed on the portable device.
  role: answer
  speaker: 增田顺一
  translation: 但当然，如果Switch是作为传统主机推出的，同时他们又另外推出了一台便携设备，我想大概可以说，我们会在便携设备上开发。
- original: In some ways, it feels like Switch is pulling you onto consoles instead of you maybe wanting to go in that direction. Does it feel like that at all?
  role: question
  speaker: Polygon
  translation: 在某些方面，感觉像是Switch把你们拉上了主机，而不是你们自己可能想往那个方向走。有这种感觉吗？
...
- original: Do you remember any specific feedback that either of you gave on this hardware?
  role: question
  speaker: Polygon
  translation: 你们还记得自己针对这款硬件提出过什么具体的反馈吗？
- original: I can’t really go into details. I did give feedback in general terms to Mr. Iwata long ago that it should be a hardware platform that people can enjoy together. So, just in general terms, that was one piece of feedback I gave.
  role: answer
  speaker: 增田顺一
  translation: 我不太能讲细节。很久以前我确实向岩田先生提过一条笼统的反馈，说它应该是一个人们可以一起享受的硬件平台。所以，笼统地说，那是我给出的一条反馈。
  note: 岩田先生指岩田聪，时任任天堂社长。
- type: image
  image: /assets/img/interviews/2019-10-24-interview-polygon-2019-swsh/002.jpg
  alt: Four characters face an enemy in Pokémon Sword and Shield
  caption: Pokémon Sword and Shield
- type: heading
  level: 2
  original: 1,000 people
  translation: 1000人
...
- original: I mean, there’s more than a hundred people who worked on debugging the game, the testing and all of that. And Creatures, they probably have a hundred people working on 3D models and everything. Now that we’re on the Switch, there’s the graphical stuff but also creating the data for the various systems in the game and everything. It just requires a lot of people to be involved.
  role: answer
  speaker: 大森滋
  translation: 我是说，有超过一百人参与游戏的调试、测试等等。而Creatures大概有一百人在做3D模型之类的工作。现在到了Switch上，有图形方面的东西，还要为游戏中的各种系统创建数据等等。这需要很多人参与。
- original: Really this time, a lot of the network features and server-side stuff and new communication features put into the game required a lot more people working on the debug side of things than before.
  role: answer
  speaker: 增田顺一
  translation: 这次真的，游戏中加入的许多网络功能、服务器端的东西以及新的通信功能，都需要比以往更多的人手来做调试方面的工作。
- original: How would the number of staff compare to what you had on previous Pokémon games?
  role: question
  speaker: Polygon
  translation: 与你们之前开发宝可梦游戏时相比，人员数量如何？
- original: I just want to make sure I don’t give the wrong impression. It’s not really a thousand-person team working on the actual content of the game. It’s really everyone who was involved in the project, including marketing and PR, advertising, localization, all that stuff.
  role: answer
  speaker: 大森滋
  translation: 我只是想确保不给人错误的印象。并不是真的有一千人的团队在制作游戏的实际内容。而是所有参与这个项目的人，包括营销、公关、广告、本地化等等。
- original: Sure, and I imagine many of those people were not full-time on this game.
  role: question
  speaker: Polygon
  translation: 当然，我想其中很多人并不是全职做这个游戏。
- original: Yes, it’s really just everyone who collaborated on the project including contractors, outsourced companies, our partners like The Pokémon Company, Pokémon Company International, Creatures, and all the other people that have been involved at any point in the development.
  role: answer
  speaker: 大森滋
  translation: 是的，实际上就是所有参与这个项目的人，包括承包商、外包公司，以及我们的合作伙伴，比如宝可梦公司、宝可梦国际公司、Creatures，还有在开发过程中任何阶段参与进来的其他所有人。
  note: Creatures是参与宝可梦集换式卡牌游戏和部分游戏开发的日本公司。
- original: So overall, how much bigger would you say, roughly speaking, this project was compared to previous games?
  role: question
  speaker: Polygon
  translation: 那么总体而言，粗略来说，这个项目比之前的游戏规模大多少？
- original: It’s hard to give a really clear answer but I’d say maybe 1.5 times the number of people as a general estimate.
  role: answer
  speaker: 增田顺一
  translation: 很难给出一个非常明确的答案，但大致估计的话，人数可能是之前的1.5倍。
- original: That’s more of just kind of speaking from feeling, though, not any kind of specific number.
  role: answer
  speaker: 大森滋
  translation: 不过，这更多只是凭感觉说的，并不是什么具体的数字。
- original: I don’t know how much direct managerial control you have over a team that size but how hard is it hard to manage these projects as they get bigger and bigger?
  role: question
  speaker: Polygon
  translation: 我不知道你对那么大的团队有多少直接的管理控制权，但随着项目越来越大，管理起来有多难？
- original: It definitely gets harder. I think the bigger the project gets and the more complex things get, it can get more difficult to make sure that everyone’s on the same page and that you’re conveying the same message to everyone and they’re understanding it. For example, I definitely have to get more specialists — like programmers who are experts in a very specific field of technology and making sure that I understand what they’re doing but also making sure that they understand what the goal for the game that they’re developing is.
  role: answer
  speaker: 大森滋
  translation: 确实越来越难。我认为项目越大、事情越复杂，就越难确保每个人都在同一页上，确保你向所有人传达相同的信息，并且他们能理解。例如，我肯定需要更多专家——比如在某个非常具体的技术领域是专家的程序员，既要确保我理解他们在做什么，也要确保他们理解他们正在开发的游戏的目标是什么。
- original: Out of the thousand or so people who have touched this game, how many do you think you could name?
  role: question
  speaker: Polygon
  translation: 在参与过这款游戏的大约一千人中，你觉得你能叫出多少人的名字？
- original: I’m pretty bad at remembering names.
  role: answer
  speaker: 大森滋
  translation: 我记名字很不在行。
- type: image
  image: /assets/img/interviews/2019-10-24-interview-polygon-2019-swsh/003.jpg
  alt: A character explores in Pokémon Sword and Shield
  caption: Pokémon Sword and Shield
- type: heading
  level: 2
  original: Legacy Pokémon
  translation: 遗留宝可梦
- original: Obviously, there’s been some criticism about not including all of the legacy Pokémon in the game. How much of that is related to the challenges of this already being a huge team and the staffing resources it would take, and how much was it a creative decision that you knew you’d have to get to eventually?
  role: question
  speaker: Polygon
  translation: 显然，有人批评游戏没有包含所有遗留宝可梦。这其中有多少是因为团队已经很大、需要的人员资源带来的挑战，又有多少是你们知道最终必须做出的创作决定？
...
- original: Do you remember how long ago you that first occurred to you? That sense of, oh, we’re going to have to draw the line sometime.
  role: question
  speaker: Polygon
  translation: 你还记得你第一次产生这种想法是什么时候吗？就是那种“哦，我们总有一天得划清界限”的感觉。
...
- original: This also comes back to the whole idea of Pokémon battles in the Galar region being this kind of sport. They’re played in gym stadiums. It’s kind of a background setting. It’s not actually in the game but we had the idea that there would be 18 gyms in the region, total. And only eight of those in either game are in the kind of major league that you actually challenge as part of your gym challenge. So we had this kind of idea that, oh, maybe some of the different types would actually be in these two different games.
  role: answer
  speaker: 大森滋
  translation: 这也要回到伽勒尔地区宝可梦对战是这种体育运动的整体设定。它们在道馆竞技场里进行。这算是一种背景设定。它实际上并没有出现在游戏里，但我们有过一个想法，那就是这个地区总共有18个道馆。而两款游戏各自只有其中8个属于那种大联盟，是你作为道馆挑战的一部分实际去挑战的。所以我们有了这样的想法：哦，也许某些不同的属性实际上会分别出现在这两款不同的游戏里。
- original: Did the reaction to Popplio influence Sobble?
  role: question
  speaker: Polygon
  translation: 球球海狮的反响影响了泪眼蜥吗？
- original: I wouldn’t say it was influenced by Popplio. The direction we really took with the starters this time was treating them as kind of a group or a set, and we wanted to give them all unique personalities as if they were a group. Sobble is more this kind of shy, timid, maybe a little bit sad character. You’ve got Scorbunny, who’s really energetic but also gets into mischief sometimes. And then there’s Grookey here who is kind of the mood maker and almost the leader of the group, and keeps the group together. So we wanted to kind of give them their own unique personalities.
  role: answer
  speaker: 大森滋
  translation: 我不会说它受到了球球海狮的影响。这次我们对初始宝可梦采取的方向，确实是把它们当作一个团体或一套来对待，我们想赋予它们各自独特的个性，就像它们是一个团体一样。泪眼蜥更像是那种害羞、胆怯、也许有点悲伤的角色。还有炎兔儿，它非常有活力，但有时也会捣蛋。然后是敲音猴，它算是气氛制造者，几乎是这个团体的领导者，把大家凝聚在一起。所以我们想赋予它们各自独特的个性。
- original: Vox Media has affiliate partnerships. These do not influence editorial content, though Vox Media may earn commissions for products purchased via affiliate links. For more information, see our ethics policy.
  role: answer
  speaker: 大森滋
  translation: Vox Media 有联盟合作伙伴关系。这些不会影响编辑内容，不过 Vox Media 可能会从通过联盟链接购买的产品中获得佣金。更多信息，请参阅我们的道德政策。
---
