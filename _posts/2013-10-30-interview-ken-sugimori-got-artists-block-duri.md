...
original_link: http://web.archive.org/web/20131030135359/http://www.officialnintendomagazine.co.uk/55616/ken-sugimori-got-artists-block-during-pokemon-x-and-y-development/
translator: Poke Amice Studio
interviewee: Thomas East, 杉森建
parallel_items:
- type: paragraph
  original: Mobile
  translation: 移动版
- type: paragraph
  original: Log in to access exclusive Nintendo content, win prizes and post on our forums. Not a member yet? Join for free
  translation: 登录以访问任天堂独家内容、赢取奖品并在我们的论坛发帖。还不是会员？免费加入
- type: paragraph
  original: A Future Site ▼
  translation: 一个未来网站 ▼
  note: 可能是网站名称或占位符，保留原文。
- type: paragraph
...
- type: paragraph
  original: Pokemon designer Ken Sugimori has admitted that he struggled to create Xerneas and Yveltal, the two main legendary Pokemon in Pokemon X and Y .
  translation: 宝可梦设计师杉森建承认，他在创作《宝可梦 X/Y》中的两只主要传说宝可梦哲尔尼亚斯和伊裴尔塔尔时遇到了困难。
- type: paragraph
  original: Speaking with Japanese magazine Famitsu, Sugimori said that he had to work with another artist at Game Freak to complete the designs of the Pokemon who adorn the front covers of Pokemon X and Pokemon Y.
  translation: 杉森建在接受日本杂志《Fami通》采访时表示，他不得不与 Game Freak 的另一位画师合作，才完成了这两只分别装饰《宝可梦 X》和《宝可梦 Y》封面的宝可梦的设计。
  note: Game Freak 是宝可梦系列的主要开发商。
- type: paragraph
...
- type: paragraph
  ...
  translation: 在线编辑
- type: paragraph
  original: Tom has been writing for games magazines and websites since the late 1990s, including GamesMaster, CVG and NGC magazine (remember that?). Read more
