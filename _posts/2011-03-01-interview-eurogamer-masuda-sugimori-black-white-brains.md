...
interviewee: Eurogamer, 增田顺一, 杉森建
toc: true
toc_sticky: true
...
- speaker: Eurogamer
  original: What is the creative order when conceptualizing a new generation? Do you begin by drawing the Pokémon first?
  translation: 在构思新世代时，创作顺序是怎样的？您是否先开始绘制宝可梦？
  role: question
- speaker: 增田顺一
  original: At first I think of ideas about what kind of play I can include. I consider playing content at first, and then what kind of world will support it. Which region? What town should be built? Once those are fixed I can start to think, 'This gym should have this type of trainer, so we should have this type of Pokémon.' You might think we always start to think from the Pokémon first, but actually we don't. We design the play, the world, and then the monsters.
  translation: 首先，我会思考可以包含什么样的玩法。我先考虑游戏内容，然后考虑什么样的世界能支撑它。哪个地区？应该建造什么样的城镇？一旦这些确定下来，我就可以开始想：“这个道馆应该有这种类型的训练家，所以我们应该有这种类型的宝可梦。”您可能认为我们总是先从宝可梦开始思考，但实际上并非如此。我们先设计玩法、世界，然后是怪物。
  role: answer
- speaker: Eurogamer
  original: Ken Sugimori, as the art director, what are the core design tenets when crafting brand new monsters?
  translation: 杉森建先生，作为艺术总监，在创作全新怪物时，核心设计原则是什么？
  role: question
- speaker: 杉森建
  original: All Pokémon shouldn't be just cold or frightening. What we consider first is players have some connectivity, a close feeling, a sense that this creature could be a genuine friend. For example, if some Pokémon have really big mouths, that could be scary. But if the shape of the body is rounded or charming, that balances it. We also consider battle balance. We need a specific number of electric, water, or fire types. What is different from other videogames is that Pokémon could be your opponent, or Pokémon could be your partner. That duality is the design core.
  translation: 所有宝可梦都不应只是冷酷或吓人的。我们首先考虑的是玩家能与之产生联系，有一种亲近感，感觉这个生物可以成为真正的朋友。例如，如果某些宝可梦嘴巴很大，那可能会吓人。但如果身体形状圆润或可爱，就能平衡这一点。我们还会考虑对战平衡。我们需要特定数量的电、水或火属性。与其他电子游戏不同的是，宝可梦既可以是你的对手，也可以是你的伙伴。这种二元性是设计的核心。
  role: answer
- type: heading
  level: 3
...
- speaker: Eurogamer
  original: How do you determine names for 156 brand new Pokémon?
  translation: 你们如何为156只全新宝可梦确定名字？
  role: question
- speaker: 增田顺一
  original: There are two different ways of approaching it. One is, sometimes our planning team already has the setting for the Pokémon, so they make a request of the designer team with a temporary name. Another approach is, designers come up with Pokémon ideas with their own draft names. Most of the time we have about five candidate names for one Pokémon. But then there's the legal trademark process in Japan and internationally to ensure the names can be used without conflict.
  translation: 有两种不同的处理方式。一种是，有时我们的企划团队已经为宝可梦设定了背景，所以他们带着临时名称向设计团队提出请求。另一种方式是，设计师提出宝可梦创意并附上自己的暂定名。大多数情况下，一只宝可梦我们会有大约五个候选名称。但之后还有日本和国际上的法律商标流程，以确保名称可以无冲突地使用。
  role: answer
- speaker: Eurogamer
  original: Where did the title 'Pokémon Black' and 'Pokémon White' come from?
  translation: 《宝可梦 黑》和《宝可梦 白》的标题从何而来？
  role: question
- speaker: 增田顺一
  original: This time, for Black and White, the main concept was extremes in the scenario. Black and White represents extremes, different perspectives, polar opposites, Truth and Ideals. This was the first time in Pokémon history where the title was chosen based on the narrative scenario and philosophical worldview, rather than minerals or colors.
  translation: 这次，对于《黑》和《白》，主要概念是剧情中的极端对立。黑与白代表极端、不同的视角、两极对立、真实与理想。这是宝可梦历史上第一次根据叙事剧情和哲学世界观来选择标题，而不是基于矿物或颜色。
  role: answer
- speaker: Eurogamer
  original: Why is the European launch happening so much closer to Japan this time, even arriving before North America?
  translation: 为什么这次欧洲发售时间与日本如此接近，甚至早于北美？
  role: question
- speaker: 增田顺一
  original: For Black and White we totally changed the scheme of the organization. This time we translated directly from Japanese to European languages! Previously, localization went from Japanese to English, and then English to other European languages. Direct Japanese-to-European translation made the launch timing much closer. We want players worldwide to experience the narrative simultaneously.
  translation: 对于《黑》和《白》，我们彻底改变了组织架构。这次我们直接从日语翻译成欧洲语言！以前，本地化是从日语到英语，然后从英语到其他欧洲语言。日语到欧洲语言的直接翻译使得发售时间更加接近。我们希望世界各地的玩家能同时体验剧情。
  note: 注：此处指本地化流程的变革，从日文直接翻译为欧洲多国语言，而非经由英文转译，从而缩短了发售间隔。
  role: answer
- speaker: Eurogamer
  original: Finally, among all the 156 new creatures, which is your personal favorite?
  translation: 最后，在所有156只新宝可梦中，您个人最喜欢哪一只？
  role: question
- speaker: 增田顺一
  original: I like Victini the best. Victini was designed by Miss Mana Ibe. The idea is that it's the Victory Pokémon, guiding players to victory. When I requested Miss Ibe design it, I specifically asked for a Pokémon that would be exceptionally appealing to women as well. I love that concept.
