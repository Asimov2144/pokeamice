...
- type: dialogue
  ...
  translation: 请杉森先生向大家介绍一下您在本作中的具体工作职责。
  note: ''
- type: dialogue
  speaker: 杉森建
...
- type: dialogue
  speaker: N.O.M采访者
  original: アドバンスでの初めてのポケモンのゲームソフトで、色数も増えました。デザイン作業をする上で、これまでと変わったところはありましたか？
  translation: 作为GBA平台上的第一部宝可梦正统新作，画面的可显示色彩数获得了飞跃性的提升。在展开设计工作时，和以往相比有什么深刻的转变吗？
  note: GBA（Game Boy Advance）最大发色数为32768色，同屏显示511色，相比Game Boy的4级灰阶有质的飞跃。
- type: dialogue
  speaker: 杉森建
  original: 今までのゲームボーイでは不可能だった公式イラストやＴＶアニメの絵に近い繊細な表現ができるようになりました。一方で、ポケモンらしくない複雑な色や形になりすぎないように気をつけました。
  translation: 由于硬件表现力的大幅进化，过去Game Boy时代根本无法实现的细腻表现——比如极度贴近官方插画甚至TV动画质感的色彩与笔触——现在全都能够在掌机屏幕上呈现了。但与此同时，我时刻高度警惕并克制自己：绝对不能为了炫技而采用过于复杂繁琐的色彩或异化形状，从而失去‘宝可梦特有的质朴本质’。
  note: 杉森建强调的‘克制美学’是宝可梦设计哲学的核心，即保持简洁与辨识度，避免过度设计。
- type: dialogue
  speaker: N.O.M采访者
  original: 杉森さんの一番のお気に入りのポケモンは、ズバリなんですか？
  translation: 杉森先生在本作中最钟爱的宝可梦究竟是哪一只呢？
  note: ''
- type: dialogue
  speaker: 杉森建
  original: 一番は決められないのですが、地味であまり人気のなさそうなポケモンほど愛着がわきます。親バカのようなものかも。
  translation: 虽然很难选出第一名，但我个人反而对那些长相朴素、看起来不太起眼甚至人气不高的宝可梦抱有最深的情感。这大概就像为人父母总是格外牵挂不起眼的孩子一样吧（笑）。
  note: ''
- type: dialogue
  speaker: N.O.M采访者
  original: Ｎ．Ｏ．Ｍ読者にメッセージを一言、お願いします。
  translation: 最后，请对期待新作的N.O.M读者们说一句话吧！
  note: ''
- type: dialogue
  speaker: 杉森建
  original: 前作同様にかわいいやつ、不気味なやつ、カッコイイやつ。たくさんの新ポケモンをデザインしました。また、「えっ、これがポケモン？」とびっくりしてしまうような姿の新キャラクターもいますので、新作ならではの新鮮さも感じてもらえると思います。 ぜひ全部のポケモンをつかまえてね！
