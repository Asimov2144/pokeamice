...
$(document).ready(function () {
  ...
  function loadTheme() {
    // White is the default. The unnamed default skin paints .initial-content
    // with randomback.php, a different image on every load, which tints
    // whatever sits on it; readers who want it can still pick Default Theme.
    applyTheme(localStorage.getItem("selectedTheme") || "white");
  }
