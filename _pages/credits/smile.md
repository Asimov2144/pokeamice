---
layout: credits-game
title: Pokémon Smile 制作名单
game: smile
permalink: /credits/smile/
search: false
sitemap: true
gf_count: 3
---
...
<li class="credits__name">Kengo Yokoyama</li>
<li class="credits__name">Takashi Maeda</li>
<li class="credits__name">Sayaka Yoshida</li>
<li class="credits__name">Mami Tsuchida</li>
<li class="credits__name">Kanahei</li>
<li class="credits__name">Reo Uratani</li>
<li class="credits__name is-gf">Ryo Katsura<img class="credits__gf" src="/assets/img/works/gamefreak-mark.svg" alt="Game Freak" title="Game Freak 成员（按名单推断：在 2 部 GF 自研作品里有开发职务署名，最早 2022）"></li>
<li class="credits__name">Aki Minemura</li>
<li class="credits__name">Yukihiro Ono</li>
...
<li class="credits__name">Huilin Wang</li>
...
<li class="credits__name">Supavita Cherdchoovanit</li>
<li class="credits__name">Ari Nirwana</li>
<li class="credits__name">Akash Gautam</li>
<li class="credits__name">Annisa Rizka Ramadani</li>
...
<li class="credits__name">Píndaro Vargas</li>
...
<li class="credits__name is-company">LITALICO Inc.</li>
<li class="credits__name is-company">NASU Co., Ltd.</li>
