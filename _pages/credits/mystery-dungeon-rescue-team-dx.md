...
<section class="credits__section">
<h3>Directors<span class="credits__zh-role">（总监）</span></h3>
<ul class="credits__names">
...
<section class="credits__section">
<h3>Event Director<span class="credits__zh-role">（事件总监）</span></h3>
<ul class="credits__names">
<li class="credits__name">Emiko Tanaka <small>田中絵美子</small></li>
</ul></section>
<section class="credits__section">
<h3>Lead Game Planner<span class="credits__zh-role">（组长游戏企划）</span></h3>
<ul class="credits__names">
<li class="credits__name">Akihiro Kaneko</li>
</ul></section>
<section class="credits__section">
<h3>Game Planners<span class="credits__zh-role">（游戏企划）</span></h3>
<ul class="credits__names">
<li class="credits__name">Sazuki Munakata</li>
<li class="credits__name">Shonosuke Morisue</li>
<li class="credits__name">Yoshihiro Tamura</li>
</ul></section>
<section class="credits__section">
<h3>Lead Programmer<span class="credits__zh-role">（组长程序员）</span></h3>
<ul class="credits__names">
...
<ul class="credits__names">
<li class="credits__name">Reo Kobayashi</li>
<li class="credits__name">Yasuyuki Yamagishi</li>
<li class="credits__name">Yusuke Kojima</li>
<li class="credits__name">Etsuo Oishi</li>
<li class="credits__name">Hiroshi Nakamura</li>
<li class="credits__name">Masaaki Sawada</li>
<li class="credits__name">Minoru Nakajima</li>
<li class="credits__name">Yoshihito Kira</li>
</ul></section>
<section class="credits__section">
<h3>Art Directors<span class="credits__zh-role">（美术总监）</span></h3>
<ul class="credits__names">
<li class="credits__name">Hiroko Takano</li>
<li class="credits__name">Keisuke Sakurai</li>
</ul></section>
<section class="credits__section">
<h3>Character Modeling<span class="credits__zh-role">（角色建模）</span></h3>
<ul class="credits__names">
<li class="credits__name">Migaku Matsui</li>
<li class="credits__name">Tetsuya Tochigi</li>
<li class="credits__name">Hideaki Tsukushi</li>
<li class="credits__name">Mio Miyasaka</li>
<li class="credits__name">Masakazu Kohama</li>
<li class="credits__name">Ku Hou</li>
</ul></section>
<section class="credits__section">
<h3>Character Animation<span class="credits__zh-role">（角色动画）</span></h3>
<ul class="credits__names">
<li class="credits__name">Wataru Nagano</li>
<li class="credits__name">Kazutaka Horikawa</li>
<li class="credits__name">Aya Hasegawa</li>
<li class="credits__name">Naoki Mori</li>
</ul></section>
<section class="credits__section">
...
<li class="credits__name">Kentarou Okanou</li>
<li class="credits__name">Satoko Matsue</li>
<li class="credits__name">Mami Sasaki</li>
</ul></section>
<section class="credits__section">
<h3>Background<span class="credits__zh-role">（背景）</span></h3>
<ul class="credits__names">
<li class="credits__name">Kosei Hatanaka</li>
<li class="credits__name">Tatsuya Morita</li>
<li class="credits__name">Eri Tominaga</li>
<li class="credits__name">Yasuhiro Oda</li>
<li class="credits__name">Hazuki Nara</li>
<li class="credits__name is-gf">Tetta Igarashi<img class="credits__gf" src="/assets/img/works/gamefreak-mark.svg" alt="Game Freak" title="Game Freak 成员（按名单推断：在 3 部 GF 自研作品里有开发职务署名，最早 2019）"></li>
<li class="credits__name">Subaru Gambe</li>
<li class="credits__name">Naoko Tochishita</li>
<li class="credits__name">Yume Iwamoto</li>
<li class="credits__name">Kiyoshi Tate</li>
<li class="credits__name">Narumi Shinomiya</li>
<li class="credits__name">Hideaki Hakozaki</li>
</ul></section>
<section class="credits__section">
<h3>Cutscenes<span class="credits__zh-role">（过场）</span></h3>
<ul class="credits__names">
...
<li class="credits__name">Shigeru Kawahara</li>
<li class="credits__name">Go Ono</li>
<li class="credits__name">Erika Suzuki</li>
<li class="credits__name">Hisashi Ikeda</li>
<li class="credits__name">Yuka Sugiyama</li>
<li class="credits__name">Daisuke Shimamua</li>
<li class="credits__name">Shoko Imaizumi</li>
<li class="credits__name">Koichiro Makino</li>
<li class="credits__name">Nobuaki Mihara</li>
<li class="credits__name">Miku Iida</li>
<li class="credits__name">Hidemitsu Masui</li>
<li class="credits__name">Yu Sato</li>
<li class="credits__name">Ryugo Koizumi</li>
</ul></section>
<section class="credits__section">
<h3>UI Designer<span class="credits__zh-role">（界面设计）</span></h3>
<ul class="credits__names">
<li class="credits__name">Jun Tomizawa</li>
</ul></section>
<section class="credits__section">
...
<section class="credits__section">
<h3>Sound Producer<span class="credits__zh-role">（音响制作人）</span></h3>
<ul class="credits__names">
<li class="credits__name">Hideki Sakamoto</li>
</ul></section>
<section class="credits__section">
<h3>Music Arrangement &amp; Composition<span class="credits__zh-role">（音乐编曲与作曲）</span></h3>
<ul class="credits__names">
<li class="credits__name">Keisuke Ito</li>
</ul></section>
<section class="credits__section">
<h3>Original Music Composition<span class="credits__zh-role">（原作音乐作曲）</span></h3>
<ul class="credits__names">
...
<li class="credits__name">Takuma Kanai</li>
<li class="credits__name">Eisei Kudo</li>
<li class="credits__name">Yuya Nakamura</li>
</ul></section>
<section class="credits__section">
...
<section class="credits__section">
<h3>Development Cooperation<span class="credits__zh-role">（开发协力）</span></h3>
<ul class="credits__names">
...
<li class="credits__name is-company">Toydea Inc.</li>
<li class="credits__name is-company">Graphinica Inc.</li>
<li class="credits__name is-company">Matchlock Corporation</li>
<li class="credits__name is-company">Pixel Sapuri LLC</li>
</ul></section>
<section class="credits__section">
<h3><small>Debug / </small>Pole To Win Co., Ltd.<span class="credits__ja-role">Debug</span></h3>
<ul class="credits__names">
<li class="credits__name">Yasuaki Maruo</li>
<li class="credits__name">Kazuhito Kawasaki</li>
<li class="credits__name">Toshiya Inui</li>
<li class="credits__name">Natsumi Seguchi</li>
<li class="credits__name">Yumi Namitoko</li>
<li class="credits__name">Sayaka Fujimura</li>
<li class="credits__name">Takehiro Ogata</li>
<li class="credits__name">Daiki Nakamura</li>
</ul></section>
<section class="credits__section">
<h3><small>Debug / </small>Digital Hearts Co., Ltd.<span class="credits__ja-role">Debug</span></h3>
<ul class="credits__names">
<li class="credits__name">Teppei Nasu</li>
<li class="credits__name">Nagisa Maruyama</li>
<li class="credits__name">Tatsuya Sakai</li>
<li class="credits__name">Takumi Takahashi</li>
</ul></section>
<section class="credits__section">
<h3><small>Debug / </small>Mario Club Co., Ltd.<span class="credits__ja-role">Debug</span></h3>
<ul class="credits__names">
...
<section class="credits__section">
<h3><small>Package Designers / </small>QBIST Inc.<span class="credits__ja-role">Package Designers</span></h3>
<ul class="credits__names">
<li class="credits__name">Nanako Kaiho</li>
<li class="credits__name">Tatsuhiko Karashima</li>
</ul></section>
<section class="credits__section">
...
<li class="credits__name is-company">(AltaSource Group)</li>
</ul></section>
<section class="credits__section">
...
<li class="credits__name">Andrew Von Arx</li>
<li class="credits__name">Marko Wallenius</li>
<li class="credits__name">Craig So</li>
<li class="credits__name">Rhiannon Winkler</li>
<li class="credits__name">Jessica Thai</li>
<li class="credits__name">Na&#x27;jee Jackson</li>
<li class="credits__name">Nicholas DeVoll</li>
<li class="credits__name">Timothy Rosaaen</li>
<li class="credits__name">James Ward</li>
<li class="credits__name">Hazel Younts</li>
...
<li class="credits__name">Christoper Derbort</li>
...
<li class="credits__name">Carolin Maribach</li>
</ul></section>
<section class="credits__section">
...
<li class="credits__name">Gabriel San Martin Fernandez</li>
</ul></section>
<section class="credits__section">
...
<li class="credits__name">Virigina Paradés Gurrea</li>
...
<section class="credits__section">
<h3>NOE Localisation Support<span class="credits__zh-role">（NOE 本地化支持）</span></h3>
<ul class="credits__names">
<li class="credits__name"><a href="/people/sawabe-ryoko/">Ryoko Sawabe</a></li>
<li class="credits__name">Sasakia Doorschodt</li>
</ul></section>
<section class="credits__section">
...
<li class="credits__name">Sandra Díaz Cabral</li>
</ul></section>
<section class="credits__section">
...
<li class="credits__name">Elisabeth Lariviere</li>
</ul></section>
<section class="credits__section">
...
<li class="credits__name">Kimi Omori</li>
...
<li class="credits__name">Daisuke Matsubara</li>
<li class="credits__name"><a href="/people/arai-kenichi/">Kenichi Arai</a></li>
<li class="credits__name">Ryohie Itakura</li>
...
<li class="credits__name">Kozue Yamaoka</li>
...
<li class="credits__name">Emi Hara</li>
...
<li class="credits__name">Yuta Fukuda</li>
<li class="credits__name">Yoshiaki Ishida</li>
<li class="credits__name">Yohei Suzuki</li>
<li class="credits__name">Kyohei Yamada</li>
<li class="credits__name">Takashi Matsuda</li>
<li class="credits__name">Takashi Mikami</li>
</ul></section>
<section class="credits__section">
...
<li class="credits__name">Tetsuya Seya</li>
</ul></section>
<section class="credits__section">
...
<li class="credits__name">Kazuyoshi Toriyama</li>
</ul></section>
<section class="credits__section">
